...
export default function About() {
  return (
    <section>
      ...
      <p>
        Let's connect and build something cool together. Feel free to reach out to me. I'm always open to new opportunities and collaborations. Reach out to me via <strong>email: (contact.sourishchatterjeer@gmail.com)</strong> or dm me on <a href="https://twitter.com/sourize_" target="_blank">Twitter</a> or <a href="https://www.instagram.com/sourish.ml/" target="_blank">Instagram</a>.
      </p>
    </section>
  );
}
